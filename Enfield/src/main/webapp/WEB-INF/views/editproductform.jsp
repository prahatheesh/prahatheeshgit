...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
 ...
 body{
  margin: 0 auto;
  background-image: url("resources/images/nfe.jpg");
...
<body>
 <div class="container">    
    ...
    <h2>EDIT PRODUCTFORM</h2>
	<form:form method="post" action="editProductform" commandName="editProdObj">
		<table>
		<tr>
        <td><form:label path="pid">Product id</form:label></td>
        <td><form:input class="form-control" path="pid" /></td>
        </tr>
        <tr>
        <td><form:label path="pname">Product Name</form:label>  </td>
        <td><form:input class="form-control" path="pname" value="${editProdObj.pname }"></form:input></td>
	    </tr>
	    <tr>
